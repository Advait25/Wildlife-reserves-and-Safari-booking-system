...
<br><br><br>-->
<p><span>PLEASE SELECT YOUR TIMING: </span><br><br>
<select name="timing">
 <option value="Morning(7:30 A.M TO 10:30 A.M)">MORNING(7:30-10:30)</option>   
    <option value="Evening(6:00 P.M TO 9 P.M)">EVENING(6:00-9:00)</option>   
</select> 
<br><br><br>
